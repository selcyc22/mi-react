...
export default class BlogForm extends Component {
    ...
    handleSubmit(event) {
        axios.post(
            "https://selcyc.devcamp.space/portfolio/portfolio_blogs", 
            this.buildForm(), 
        ...
        return (
            <form onSubmit={this.handleSubmit} className='blog-form-wrapper'>
                <div className='two-column'>
                    ...
                    <input type="text" onChange={this.handleChange} name="blog_status" placeholder='blog title' value={this.state.blog_status} />
                </div>
