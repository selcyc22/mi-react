...
export default class PortfolioForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            logo:"",
            editMode: false,
            apiUrl:"https://selcyc.devcamp.space/portfolio/portfolio_items",
            apiAciton:"post"
        };
    ...
    componentDidUpdate() {
        if (Object.keys(this.props.PortfolioToEdit).length > 0) {
            ...
            this.setState({
                ...
                url:url || "",
                editMode: true,
                apiUrl:`https://selcyc.devcamp.space/portfolio/portfolio_items/${id}`,
                apiAciton:"patch",
    ...
    handleSubmit(event) {
        ...
        .then(response => {
            ...
            [this.thumbRef, this.bannerRef, this.logoRef].forEach(ref => {
                ref.current.dropzone.removeAllFil();
            });
        }).catch(error => {
        ...
        return (                
                ...
                <form onSubmit={this.handleSubmit} className="portfolio-form-wrapper">
                    ...
                    <div className="one-column">
                        <textarea type="text" name="description" placeholder="Discription" value={this.state.description} onChange={this.handleChange} />
                    </div>
